...
Type (`WizType`): display face Big Shoulders Display, hero face Neumatic Compressed (amended 2026-09-12 after the gallery review: Neumatic reads only at hero size, so it keeps the 64 px hero and Big Shoulders takes every other display style), UI face Hanken Grotesk, mono JetBrains Mono. hero 64 / 0.92 / −0.005 em / 800 (Neumatic takes a tracking floor of 1 px + 0.03 em on Impeller instead); display 44 / 0.98 / 0.005 em / 700; title 30 / 1.06 / 0.015 em / 700; heading 23 / 1.16 / 0.025 em / 600; bodyLg 17 / 1.5; body 15 / 1.5; bodySm 13 / 1.45; caption 11 / 1.35 / 0.06 em; label 11 uppercase / 0.10 em; readout 34 / 1 / 700 tabular; readoutSm 18; code 12.5 / 1.55 mono. Letter-spacing in em converts to `size × em` logical pixels.
...
Bundled in `assets/fonts/`: Big Shoulders Display 600/700/800/900 (TTF, static instances of Google Fonts' variable font, OFL, licence file included; amended 2026-09-12); Neumatic Compressed ExtraBold 800 only (OTF, fetched from the design project; the hero's face); Hanken Grotesk 400/600/700 and JetBrains Mono 400/500/700 (TTF from Google Fonts, OFL, licence files included). No images, no logo mark, no audio files.
